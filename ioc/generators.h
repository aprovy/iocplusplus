...
struct unpack_dependency
{
	...
	// dependency placeholders for a factory signature used in the container
	typedef typename boost::mpl::if_c<
		is_placeholder != 0,
		typename boost::mpl::vector1<typename get_actual_placeholder<placeholders, dependency_descriptor>::type>,
		typename generate_resolver_type::signature_placeholders
...
struct generate_resolver<dependency, bind_type, placeholders, 0>
{
	...
	typedef typename merge_placeholders<>::result signature_placeholders;
};
...
struct generate_resolver<dependency, bind_type, placeholders, 1>
{
	...
	typedef typename merge_placeholders<
		typename d0::signature_params
	>::result signature_placeholders;
};
